...
$adminOrderDetail = new \Controllers\AdminOrderDetailAction();
$adminOrderDetail->execute();
$details = $adminOrderDetail->getOrderDetail();
$order = $adminOrderDetail->getOrderHistory();
?>
		    ...
		    <div class="main_wrapper">
		        <div class="main_contents">
                    <div class="admin_title">
                        <h2><a href="/html/admin/admin_orders.php">購入履歴管理画面 </a></h2>
                    </div>
                     <div class="main_contents_inner">
                        ...
                        <div class="box-shipping-sub">
                            ...
                            <div class="btn_link_wrap">
                                <a href="/html/admin/admin_orders.php" class="btn_cmn_01 btn_design_03">ご注文履歴に戻る</a>
                            </div>
                        </div> 
                    </div>
                </div>
