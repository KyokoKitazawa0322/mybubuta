                ...
                <div class="register_wrapper">
                    ...
                    <div class="register_field name_field">
                        <div class="register_form_row">
                            ...
                            <div class="name_input_wrapper">
                                <input class="form_input_item <?php if($myPageUpdate->getLastNameError()){echo "error_box";}?>" type="text" maxlength="20" name="last_name" value="<?php if(isset($_SESSION['update'])){echo Config::h($_SESSION['update']['last_name']);}else{echo $customer->getLastName();} ?>"/>
                            </div>
                            <p class="name_label">名</p>
                            <div class="name_input_wrapper">
                                <input class="form_input_item <?php if($myPageUpdate->getFirstNameError()){echo "error_box";}?>" type="text" maxlength="20" name="first_name" value="<?php if(isset($_SESSION['update'])){echo Config::h($_SESSION['update']['first_name']);}else{echo $customer->getFirstName();}?>"/>
                            </div>
                        ...
                        <div class="register_form_row">
                            ...
                            <div class="name_input_wrapper">
                                <input class="form_input_item <?php if($myPageUpdate->getRubyLastNameError()){echo "error_box";}?>" type="text" maxlength="20"  name="ruby_last_name" value="<?php if(isset($_SESSION['update'])){echo Config::h($_SESSION['update']['ruby_last_name']);}else{ echo $customer->getRubyLastName();} ?>"/>
                            </div>
                            <p class="name_label">メイ</p>
                            <div class="name_input_wrapper">
                                <input class="form_input_item <?php if($myPageUpdate->getRubyFirstNameError()){echo "error_box";}?>"  type="text" maxlength="20" name="ruby_first_name"  value="<?php if(isset($_SESSION['update'])){echo Config::h($_SESSION['update']['ruby_first_name']);}else{echo $customer->getRubyFirstName();}?>"/>
                            </div>
                    ...
                    <div class="register_field tel_field">
                        <div class="register_form_row">
                            ...
                            <input class="form_input_item <?php if($myPageUpdate->getTelError()){echo "error_box";}?>" name="tel" type="tel" maxlength="11" id="tel" value="<?php if(isset($_SESSION['update'])){echo Config::h($_SESSION['update']['tel']);}else{echo $customer->getTel();}?>"/>
                            <div class="memo_wrapper">
                    ...
                    <div class="register_field mail_field">
                        <div class="register_form_row">
                            ...
                            <input class="form_input_item <?php if($myPageUpdate->getMailError()){echo "error_box";}?>" type="text" maxlength="100" name="mail" id="mail"  value="<?php if(isset($_SESSION['update'])){echo Config::h($_SESSION['update']['mail']);}else{echo $customer->getMail();}?>"/>
                            <div class="memo_wrapper">
