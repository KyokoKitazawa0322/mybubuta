                    ...
                    <div class="register_form">
                        ...
                        <div class="confirm_button_wrapper">
                            <div class="confirm_button_inner">
                                <input class="btn_cmn_mid btn_design_03" type="button" onClick="location.href='/html/mypage/mypage_delivery_add.php'" value="前の画面に戻る"/>
                            </div>
                            <form action="/html/mypage/mypage_delivery_add_complete.php" method="POST">
                                <div class="confirm_button_inner">
