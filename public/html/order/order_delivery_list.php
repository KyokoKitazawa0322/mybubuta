...
<div class="wrapper">
                ...
                <div class="main_contents_inner">
                    <form action="/html/order/order_confirm.php" method="POST">
                        ...
                        <div class="mypage_addr_box">
                            <div class="box_info">                           
                                <input name="def_addr" type="radio" id="def_addr" value="1" <?php if($orderDeliveryList->checkCustomer($customer)){echo 'checked="checked"';}?>>
    ...
    <form method="POST" id="base-addr-update" action="/html/mypage/mypage_update.php">
