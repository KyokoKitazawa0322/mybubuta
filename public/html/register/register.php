                    ...
                    <form method="POST" action="#" class="register_form">
                        <div class="register_field name_field">
                            <div class="register_form_row">
                                ...
                                <div class="name_input_wrapper">
                                    <input class="form_input_item <?php if($register->getLastNameError()){echo "error_box";}?>" type="text" maxlength="20" name="last_name" value="<?php if(isset($_SESSION['register']['last_name'])){echo $_SESSION['register']['last_name'];}?>">
                                </div>
                                <p class="name_label">名</p>
                                <div class="name_input_wrapper">
                                    <input class="form_input_item <?php if($register->getFirstNameError()){echo "error_box";}?>" type="text" maxlength="20" name="first_name" value="<?php if(isset($_SESSION['register']['first_name'])){echo $_SESSION['register']['first_name'];}?>">
                                </div>
                            ...
                            <div class="register_form_row">
                                ...
                                <div class="name_input_wrapper">
                                    <input class="form_input_item <?php if($register->getRubyLastNameError()){echo "error_box";}?>" type="text" maxlength="20"  name="ruby_last_name" value="<?php if(isset($_SESSION['register']['ruby_last_name'])){echo $_SESSION['register']['ruby_last_name'];}?>">
                                </div>
                                <p class="name_label">メイ</p>
                                <div class="name_input_wrapper">
                                    <input class="form_input_item <?php if($register->getRubyFirstNameError()){echo "error_box";}?>" type="text" maxlength="20" name="ruby_first_name" value="<?php if(isset($_SESSION['register']['ruby_first_name'])){echo $_SESSION['register']['ruby_first_name'];}?>">
                                </div>
                        ...
                        <div class="register_field">
                            <div class="register_form_row">
                                ...
                                <div class="addr01_input_wrapper">
                                    <input class="form_input_item <?php if($register->getAddress01Error()){echo "error_box";}?>" type="tel" name="address01" maxlength="3" id="add01" value="<?php if(isset($_SESSION['register'])){echo $_SESSION['register']['address01'];}?>">
                                </div>
                                <span class="txt_dash">―</span>
                                <div class="addr01_input_wrapper">
                                    <input class="form_input_item <?php if($register->getAddress02Error()){echo "error_box";}?>" type="tel" name="address02" maxlength="4" id="add02" value="<?php if(isset($_SESSION['register'])){echo $_SESSION['register']['address02'];}?>">
                                </div>
                            ...
                            <div class="register_form_row">
                                ...
                                <input class="form_input_item <?php if($register->getAddress04Error()){echo "error_box";}?>" type="text" maxlength="50" id="add04" name="address04"  value="<?php if(isset($_SESSION['register'])){echo $_SESSION['register']['address04'];}?>">
                            ...
                            <div class="register_form_row">
                                ...
                                <input class="form_input_item <?php if($register->getAddress05Error()){echo "error_box";}?>" type="text" maxlength="50" id="add05" name="address05" value="<?php if(isset($_SESSION['register'])){echo $_SESSION['register']['address05'];}?>">
                            ...
                            <div class="register_form_row">
                                ...
                                <input class="form_input_item" type="text" maxlength="100" name="address06" id="add06" value="<?php if(isset($_SESSION['register'])){echo $_SESSION['register']['address06'];}?>">
                                <div class="memo_wrapper">
                        ...
                        <div class="register_field tel_field">
                            <div class="register_form_row">
                                ...
                                <input class="form_input_item <?php if($register->getTelError()){echo "error_box";}?>" name="tel" type="tel" maxlength="11" id="tel" value="<?php if(isset($_SESSION['register'])){echo $_SESSION['register']['tel'];}?>">
                                <div class="memo_wrapper">
                        ...
                        <div class="register_field mail_field">
                            <div class="register_form_row">
                                ...
                                <input class="form_input_item <?php if($register->getMailError()){echo "error_box";}?>" type="text" maxlength="100" name="mail" id="mail" value="<?php if(isset($_SESSION['register'])){echo $_SESSION['register']['mail'];}?>">
                                <div class="memo_wrapper">
