...
if(isset($_POST['cmd'])&& $_POST['cmd']=='register_del'){ 
    ...
    if(!$isLastNameError && !$isFirstNameError && !$isRubyFirstNameError && !$isRubyLastNameError && !$isTelError && !$isZipcodeFirstError && !$isZipcodeLastError && !$isAdd03Error && !$isAdd04Error && !$isAdd05Error) {
        ...
        header('Location:mypage_delivery_complete.php');
        exit();
    }
}
                ...
                <div class="register_wrapper">
                    ...
                    <div class="register_field name_field">
                        <div class="register_form_row">
                            ...
                            <div class="name_input_wrapper">
                                <input class="form_input_item <?php if(isset($isLastNameError) && $isLastNameError){echo "error_box";}?>" type="text" maxlength="20" name="name01" id="name01" value="<?php if(isset($_SESSION['del_update']['name01'])){echo $_SESSION['del_update']['name01'];}else{echo $result['last_name'];} ?>"/>
                            </div>
                            <p class="name_label">名</p>
                            <div class="name_input_wrapper">
                                <input class="form_input_item <?php if(isset($isFirstNameError) && $isFirstNameError){echo "error_box";}?>" type="text" maxlength="20" name="name02" id="name02" value="<?php if(isset($_SESSION['del_update']['name02'])){echo $_SESSION['del_update']['name02'];}else{echo $result['first_name'];} ?>"/>
                            </div>
                        ...
                        <div class="register_form_row">
                            ...
                            <div class="name_input_wrapper">
                                <input class="form_input_item <?php if(isset($isRubyLastNameError) && $isRubyLastNameError){echo "error_box";}?>" type="text" maxlength="20"  name="name03" id="name03" value="<?php if(isset($_SESSION['del_update']['name03'])){echo $_SESSION['del_update']['name03'];}else{echo $result['ruby_last_name'];} ?>"/>
                            </div>
                            <p class="name_label">メイ</p>
                            <div class="name_input_wrapper">
                                <input class="form_input_item <?php if(isset($isRubyFirstNameError) && $isRubyFirstNameError){echo "error_box";}?>" type="text" maxlength="20" name="name04" id="name04" value="<?php if(isset($_SESSION['del_update']['name04'])){echo $_SESSION['del_update']['name04'];}else{echo $result['ruby_first_name'];}?>"/>
                            </div>
                    ...
                    <div class="register_field">
                        <div class="register_form_row">
                            ...
                            <div class="addr01_input_wrapper">
                                <input class="form_input_item <?php if(isset($isZipcodeFirstError) && $isZipcodeFirstError){echo "error_box";}?>" type="tel" name="add01" maxlength="3" id="add01" value="<?php if(isset($_SESSION['del_update']['add01'])){echo $_SESSION['del_update']['add01'];}else{echo $result['address_01'];}?>"/>
                            </div>
                            <span class="txt_dash">―</span>
                            <div class="addr01_input_wrapper">
                                <input class="form_input_item <?php if(isset($isZipcodeLastError) && $isZipcodeLastError){echo "error_box";}?>" type="tel" name="add02" maxlength="4" id="add02" value="<?php if(isset($_SESSION['del_update']['add02'])){echo $_SESSION['del_update']['add02'];}else{echo $result['address_02'];}?>"/>
                            </div>
                            ...
                            <div class="add_list_wrapper">
                               <select class="add_list <?php if(isset($isAdd03Error) && $isAdd03Error){echo "error_box";}?>" name="add03">
                                    ...
                                    foreach($all as $kenmei) {
                                        if(isset($_SESSION['del_update'])){
                                            if($_SESSION['del_update']['add03'] == $kenmei){
                        ...
                        <div class="register_form_row">
                            ...
                            <input class="form_input_item <?php if(isset($isAdd04Error) && $isAdd04Error){echo "error_box";}?>" type="text" maxlength="50" id="add04" name="add04" value="<?php if(isset($_SESSION['del_update'])){echo $_SESSION['del_update']['add04'];}else{echo $result['address_04'];}?>"/>
                        ...
                        <div class="register_form_row">
                            ...
                            <input class="form_input_item <?php if(isset($isAdd05Error) && $isAdd05Error){echo "error_box";}?>" type="text" maxlength="50" id="add05" name="add05" value="<?php if(isset($_SESSION['del_update'])){echo $_SESSION['del_update']['add05'];}else{echo $result['address_05'];}?>"/>
                        ...
                        <div class="register_form_row">
                            ...
                            <input class="form_input_item" type="text" maxlength="100" id="add06" name="add06" value="<?php if(isset($_SESSION['del_update'])){echo $_SESSION['del_update']['add06'];}else{echo $result['address_06'];}?>"/>
                            <div class="memo_wrapper">
                    ...
                    <div class="register_field tel_field">
                        <div class="register_form_row">
                            ...
                            <input class="form_input_item <?php if(isset($isTelError) && $isTelError){echo "error_box";}?>" name="tel" type="tel" maxlength="11" id="tel" value="<?php if(isset($_SESSION['del_update'])){echo $_SESSION['del_update']['tel'];}else{echo $result['tel'];}?>"/>
                            <div class="memo_wrapper">
